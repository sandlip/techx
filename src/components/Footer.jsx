      ...
      <div className='bg-black text-white px-4'>
        ...
        <section className="flex flex-col-reverse sm:flex-row items-center justify-between py-10 px-6">
          ...
          <div className="flex items-center justify-center gap-x-6">
            {/* <a href="https://facebook.com" target="_blank" rel="noreferrer" className="text-xl hover:text-[#4267B2]">
              <i className="bi bi-facebook-f"></i>
            </a>
  
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="text-xl bg-clip-text hover:text-transparent hover:bg-gradient-to-tr from-[#feda75] via-[#fa7e1e] to-[#d62976]">
              <i className="bi bi-instagram"></i>
            </a> */}
  
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="text-xl hover:text-[#0077b5]">
              <i className="bi bi-linkedin"></i>
            </a>
  
            <a href="https://twitter.com" target="_blank" rel="noreferrer" className="text-xl hover:text-[#1DA1F2]">
              <i className="bi bi-twitter"></i>
            </a>
            
            <a href="https://youtube.com" target="_blank" rel="noreferrer" className="text-xl hover:text-[#FF0000]">
